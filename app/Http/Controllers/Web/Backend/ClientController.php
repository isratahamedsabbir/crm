...
class ClientController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            $user = auth('web')->user();
            $data = Client::query()->with('category', 'user')->where('user_id', $user->id)->orderBy('id', 'desc')->get();
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    return '<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                ...
                                <a href="#" type="button" onclick="goToInteraction(' . $data->id . ')" class="btn btn-warning fs-14 text-white delete-icn" title="Delete">
        ...
        return view("backend.layouts.client.index");
    }
    ...
    public function create()
    {
        ...
        return view('backend.layouts.client.create', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            session()->put('t-success', 'client created successfully');
        ...
        return redirect()->route('admin.client.index')->with('t-success', 'client created successfully');
    }
    ...
    {
        $client = Client::with(['category', 'user'])->where('id', $id)->first();
        return view('backend.layouts.client.show', compact('client'));
    }
    ...
    public function edit(client $client, $id)
    {
        ...
        $categories = Category::where('status', 'active')->get();
        return view('backend.layouts.client.edit', compact('client', 'categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            session()->put('t-success', 'Client updated successfully');
        ...
        return redirect()->route('admin.client.edit', $client->id)->with('t-success', 'Client updated successfully');
    }
